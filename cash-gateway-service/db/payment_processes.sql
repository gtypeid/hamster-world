...
CREATE TABLE payment_processes (
                                  ...
                                  last_pg_response_code VARCHAR(10) NULL COMMENT '마지막 PG 응답 코드 (HTTP Status: 202, 200, 400 등)',
                                  ...
                                  KEY idx_payment_processes_user_public_id (user_public_id),
                                  KEY idx_provider_mid_status (provider, mid, status),
