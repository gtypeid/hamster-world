...
class PaymentEventConsumer(
    ...
    private fun handleOrderStockReserved(parsedEvent: ParsedEvent) {
        ...
        logger.info(
            "[재고 확보 완료] PG 요청 시작 | orderPublicId={} | userPublicId={} | orderNumber={} | amount={} | provider={} | traceId={}",
            eventDto.orderPublicId, eventDto.userPublicId, eventDto.orderNumber, eventDto.totalPrice,
